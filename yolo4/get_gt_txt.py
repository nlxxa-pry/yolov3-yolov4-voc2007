...
image_ids = open('/root/pix2pix_dy/y3/VOCdevkit/VOC2007_test/ImageSets/Main/test.txt').read().strip().split()
...
for image_id in image_ids:
    with open("./input/ground-truth/"+image_id+".txt", "w") as new_f:
        root = ET.parse("/root/pix2pix_dy/y3/VOCdevkit/VOC2007_test/Annotations/"+image_id+".xml").getroot()
